...
SET(ENABLE_OPENMP 1)
IF(ENABLE_OFFLOAD)
    SET(CMAKE_C_FLAGS     "${CMAKE_C_FLAGS} -fopenmp -fopenmp-targets=nvptx64-nvidia-cuda --cuda-path=$ENV{OLCF_CUDA_ROOT}")
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fopenmp -fopenmp-targets=nvptx64-nvidia-cuda --cuda-path=$ENV{OLCF_CUDA_ROOT}")
ELSE()
