...
void buildJeeI(JeeIType& JeeI, double rcut)
{
  ...
  {
    std::vector<RealType> params = {8.227710241e-06,  2.480817653e-06,  -5.354068112e-06, -1.112644787e-05,
  ...
  {
    std::vector<RealType> params = {-6.939530224e-06, 2.634169299e-05,  4.046077477e-05, -8.002682388e-06,
