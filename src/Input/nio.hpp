...
void buildJeeI(JeeIType& JeeI, double rcut)
{
  ...
  { // add uuNi
    std::vector<RealType> Y = {-0.003356164484, 0.002412623253,  0.01653623839,   0.0008341346169, -0.002808360734,
                               0.000710697475,  0.01076942152,   0.0009228283355, 0.01576022161,   -0.003585259096,
                               0.003323106938,  -0.02282975998,  -0.002246144403, -0.007196992871, -0.00404316239,
                               0.001465337212,  0.02026982926,   -0.03528735393,  0.04594087928,   -0.008776410679,
                               -0.001552528476, -0.005554407743, 0.001858594451,  0.002001634408,  0.0009302256139,
                               -0.0006304447229};
    std::string suu("uuNi");
    Func* f          = new Func;
  ...
  { // add udNi
    std::vector<RealType> Y = {-0.006861627197, 0.003278047306, 0.03324006545,   0.003097361067, -0.004710623571,
                               9.652180317e-06, 0.02212708787,  -0.003718893286, 0.03390124932,  -0.00710566395,
                               0.008807743592,  -0.04281661568, -0.008463011294, -0.01269994613, -0.002005229447,
                               0.002186590944,  0.03350196472,  -0.05677253817,  0.07810604648,  -0.009629896208,
                               -0.006372643712, -0.01056861605, 0.002485188615,  0.008392442289, 1.073423014e-05,
                               -0.0004812466328};
    std::string suu("udNi");
    Func* f          = new Func;
    f->cutoff_radius = rcut;
  ...
  { // add uuO
    std::vector<RealType> Y = {-0.003775082438, -0.00169971229, 0.02162925441,  0.005674020544, -0.0008296047161,
                               0.00128057705,   0.005487203215, 0.001637322446, 0.02976838198,  -0.0003207100945,
                               0.01143855436,   -0.05336741304, -0.00732359381, -0.01556942626, 0.0001149478453,
                               0.001838601199,  0.02570154203,  -0.0675325214,  0.1080671614,   -0.01258358969,
                               0.001839834045,  -0.02422400426, 0.005154953014, 0.003510582598, 0.007464427016,
                               -0.002454817757};
    std::string suu("uuO");
    Func* f          = new Func;
    f->cutoff_radius = rcut;
  ...
  { // add udO
    std::vector<RealType> Y = {-0.009590393593, 0.002498010871, 0.04225872633,  0.00460311261,  -0.01071033503,
                               0.001253155062,  0.02934351285,  -0.01823794726, 0.07224890393,  -0.01020046849,
                               0.006310807929,  -0.05655009412, -0.0363775247,  0.002062411388, 0.02037856173,
                               0.003372676617,  0.03915277249,  -0.02680556816, 0.08648136635,  0.01499088063,
