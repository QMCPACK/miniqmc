...
int main(int argc, char** argv)
{
  ...
  spo_type spo_main;
  using spo_ref_type=einspline_spo<OHMMS_PRECISION, MultiBsplineRef<OHMMS_PRECISION> >;
  ...
  {
    cout << "Fail in evaluate_vgh, V error =" << evalVGH_v_err/np << std::endl;
    fail = true;
  }
  if ( evalVGH_g_err/np > small_g )
  {
    cout << "Fail in evaluate_vgh, G error =" << evalVGH_g_err/np << std::endl;
    fail = true;
  }
  if ( evalVGH_h_err/np > small_h )
  {
    cout << "Fail in evaluate_vgh, H error =" << evalVGH_h_err/np << std::endl;
    fail = true;
  }
