...
template<class T, unsigned D>
 typename Tensor<T, D>::Type_t det(const Tensor<T, D>& a)
{
...
//////////////////////////////////////////////////////
template<class T>
 typename Tensor<T, 1>::Type_t det(const Tensor<T, 1>& a)
{
  return a(0, 0);
}
...
//////////////////////////////////////////////////////
template<class T>
 typename Tensor<T, 2>::Type_t det(const Tensor<T, 2>& a)
{
...
//////////////////////////////////////////////////////
template<class T>
 typename Tensor<T, 3>::Type_t det(const Tensor<T, 3>& a)
{
