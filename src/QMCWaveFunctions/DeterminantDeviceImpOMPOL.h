\#ifndef QMCPLUSPLUS_DETERMINANT_DEVICE_IMP_OMPOL_H
#define QMCPLUSPLUS_DETERMINANT_DEVICE_IMP_OMPOL_H
...
#pragma omp master
  ...
  template<>
  class DeterminantDeviceImp<DDT::OMPOL> : public DeterminantDevice<DeterminantDeviceImp<DDT::KOKKOS>>
  {
  public:
   ...
   */
    ...
    inline void transfer_from_device() { psiMinv.update_from_device(); }
