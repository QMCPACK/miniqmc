...
public:
  ...
  *
  * WalkerOffsets[0]=0 and WalkerOffsets[WalkerOffsets.size()-1]=total number of
  * walkers in a group
  * WalkerOffsets[processorid+1]-WalkerOffsets[processorid] is equal to the
  * number of walkers on a processor,
